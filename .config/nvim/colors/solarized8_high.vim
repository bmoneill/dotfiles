...
if !get(g:, 'solarized_use16', &t_Co < 256)
  if &background ==# 'dark'
    ...
    if !has('gui_running') && get(g:, 'solarized_termtrans', 0)
      ...
      hi Normal ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi FoldColumn ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
      hi Folded ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=#002b36 cterm=NONE,bold gui=NONE,bold
      hi LineNr ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
      hi Terminal ctermfg=fg ctermbg=NONE guifg=fg guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi CursorLineNr ctermbg=NONE guibg=#073642
    endif
    if get(g:, "solarized_visibility", "") == "high"
      ...
      hi SpellBad ctermfg=61 ctermbg=NONE guifg=#6c71c4 guibg=#fdf6e3 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellCap ctermfg=61 ctermbg=NONE guifg=#6c71c4 guibg=#fdf6e3 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellLocal ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellRare ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    ...
    elseif get(g:, "solarized_visibility", "") == "low"
      ...
      hi SpecialKey ctermfg=246 ctermbg=NONE guifg=#839496 guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
      hi SpellBad ctermfg=61 ctermbg=NONE guifg=#6c71c4 guibg=NONE guisp=#cb4b16 cterm=NONE,underline gui=NONE,undercurl
      hi SpellCap ctermfg=61 ctermbg=NONE guifg=#6c71c4 guibg=NONE guisp=#cb4b16 cterm=NONE,underline gui=NONE,undercurl
      hi SpellLocal ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=#b58900 cterm=NONE,underline gui=NONE,undercurl
      hi SpellRare ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=NONE guisp=#2aa198 cterm=NONE,underline gui=NONE,undercurl
    ...
    hi ColorColumn ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=NONE cterm=NONE gui=NONE
    ...
    hi CursorColumn ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=NONE cterm=NONE gui=NONE
    hi CursorLine ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=#eee8d5 cterm=NONE gui=NONE
    ...
    elseif get(g:, "solarized_diffmode", "") == "low"
      ...
      hi DiffAdd ctermfg=106 ctermbg=NONE guifg=#859900 guibg=#073642 guisp=#859900 cterm=NONE gui=NONE
      hi DiffChange ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#073642 guisp=#b58900 cterm=NONE gui=NONE
      hi DiffDelete ctermfg=160 ctermbg=NONE guifg=#dc322f guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
      hi DiffText ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=#073642 guisp=#268bd2 cterm=NONE gui=NONE
    endif
    hi Directory ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi EndOfBuffer ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi ErrorMsg ctermfg=160 ctermbg=NONE guifg=#dc322f guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi IncSearch ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,standout gui=NONE,standout
    hi MatchParen ctermfg=230 ctermbg=NONE guifg=#fdf6e3 guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
    ...
    hi Pmenu ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
    ...
    if get(g:, "solarized_statusline", "") == "low"
      hi StatusLine ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi StatusLineNC ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLine ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLineFill ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLineSel ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    elseif get(g:, "solarized_statusline", "") == "flat"
      hi StatusLine ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi StatusLineNC ctermfg=236 ctermbg=254 guifg=#073642 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLineSel ctermfg=230 ctermbg=NONE guifg=#fdf6e3 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
      hi TabLine ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
      hi TabLineFill ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
      hi VertSplit ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
    else
      hi StatusLine ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi StatusLineNC ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLine ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLineFill ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi TabLineSel ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      hi VertSplit ctermfg=236 ctermbg=243 guifg=#073642 guibg=#657b83 guisp=NONE cterm=NONE gui=NONE
    endif
    hi! link StatusLineTerm StatusLine
    hi! link StatusLineTermNC StatusLineNC
    hi Visual ctermfg=243 ctermbg=NONE guifg=#657b83 guibg=#002b36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi VisualNOS ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi WarningMsg ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi WildMenu ctermfg=230 ctermbg=NONE guifg=#fdf6e3 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    hi ToolbarLine ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=NONE cterm=NONE gui=NONE
    hi ToolbarButton ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi NormalMode ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi InsertMode ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi ReplaceMode ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi VisualMode ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi CommandMode ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    if get(g:, 'solarized_extra_hi_groups', 0)
      ...
      hi perlHereDoc ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi perlVarPlain ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi perlStatementFileDesc ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi texstatement ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi texmathzonex ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi texmathmatcher ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi texreflabel ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi rubyDefine ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#002b36 guisp=NONE cterm=NONE,bold gui=NONE,bold
      hi! link rubySymbol Type
      hi rubyBoolean ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      ...
      hi pandocTableZebraLight ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=#002b36 guisp=NONE cterm=NONE gui=NONE
      hi pandocTableZebraDark ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=#073642 guisp=NONE cterm=NONE gui=NONE
  ...
  if !has('gui_running') && get(g:, 'solarized_termtrans', 0)
    ...
    hi Normal ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    ...
    hi Terminal ctermfg=fg ctermbg=NONE guifg=fg guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  ...
  if get(g:, "solarized_visibility", "") == "high"
    ...
    hi SpellBad ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellCap ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellLocal ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellRare ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  ...
  hi PmenuSbar ctermfg=NONE ctermbg=NONE guifg=NONE guibg=#073642 guisp=NONE cterm=NONE gui=NONE
  ...
  if get(g:, "solarized_statusline", "") == "low"
    hi StatusLine ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi StatusLineNC ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLineFill ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLineSel ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi VertSplit ctermfg=236 ctermbg=247 guifg=#073642 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  elseif get(g:, "solarized_statusline", "") == "flat"
    hi StatusLine ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#002b36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi StatusLineNC ctermfg=254 ctermbg=NONE guifg=#eee8d5 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    hi WildMenu ctermfg=242 ctermbg=NONE guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  else
    ...
    hi VertSplit ctermfg=236 ctermbg=247 guifg=#073642 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=66 ctermbg=NONE guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  endif
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi Visual ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi NormalMode ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi InsertMode ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ReplaceMode ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualMode ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi CommandMode ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  if get(g:, 'solarized_extra_hi_groups', 0)
    ...
    hi javaScript ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link jsFuncCall Function
    hi perlHereDoc ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi perlVarPlain ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi perlStatementFileDesc ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi texstatement ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi texmathzonex ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi texmathmatcher ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi texreflabel ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi rubyDefine ctermfg=236 ctermbg=NONE guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi! link rubySymbol Type
    hi rubyBoolean ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    let hs_highlight_boolean=1
    let hs_highlight_delimiters=1
    hi cPreCondit ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi VarId ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi! link pandocTableStructureTop pandocTableStructre
    hi! link pandocTableStructureEnd pandocTableStructre
    hi pandocTableZebraLight ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
